					...
					<form method="POST" action="IngresarSolicitudController.do">
						<div class="card">
							...
							<div class="card-content d">
								<div class="field">
									<label class="label has-text-centered" for="rut-txt">Rut de Cliente</label>
									<div class="control">
										<input type="number" class="input" id="rut-txt" name="rut-txt" placeholder="Ingrese Rut Sin Puntos ni Guion"/>
									</div>
								</div>
							</div>
								...
								<div class="field has-text-centered">
									...
									<div class="control">
										<input type="text" class="input" id="nombre-txt"
											name="nombre-txt" placeholder="Ingrese Nombre y Apellido con un espacio entre medio" />
									</div>
								</div>
							</div>
							<div class="card-content">
								<div class="field">
									<label class="label has-text-centered" for="tipo-select">Tipo de
										Solicitud</label>
									<div class="control">
										<div class="select">
